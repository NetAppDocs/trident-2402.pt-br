...
Ao usar o nvme/tcp em ambientes k8s com nomes de nós longos, os pods não podem ser anexados ao armazenamento.

.Solução alternativa
Reduza o nome do nó para que o nome do subsistema tenha menos de 64 carateres.
