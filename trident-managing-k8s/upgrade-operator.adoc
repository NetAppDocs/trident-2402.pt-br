...
NOTE: Para atualizar a partir do Astra Trident instalado usando o operador com escopo de namespace (versões 20.07 a 20.10), utilize as instruções de atualização para a sua versão instalada do Astra Trident.
