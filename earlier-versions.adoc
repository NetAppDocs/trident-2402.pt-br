...
[role="lead"]
Se você não estiver executando o Astra Trident 24,02, a documentação das versões anteriores estará disponível com base link:get-help.html["Ciclo de vida do suporte ao Astra Trident"]no .
